...
import {IUserPatientData} from "../types/profileAnalysisTypes";


const initialState: IUserPatientData = {
...
const patientPaymentSlice = createSlice({
    name: "patientPaymentSlice",
    initialState,
    reducers: {
...
export const {reducer: profileAnalysisReducer} = patientPaymentSlice
export const {actions: profileAnalysisActions} = patientPaymentSlice